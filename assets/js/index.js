const data = [
   ...
   async function createPost() {
    ...
    console.log(jwttoken);
        ...
        likeComment.innerHTML = "<i class='bx bx-heart'></i> <i class='bx bx-message-rounded-dots'></i>";

        const likeCommentTotal = document.createElement('div');
        likeCommentTotal.className = 'likeCommentTotal';
        likeCommentTotal.innerHTML = '<p><strong>106</strong> Likes</p><p class="showComment">View all <strong>18</strong> Comments</p>';
    ...
    //     ]
        ...
        <div class="commentInput">
            ...
            <div class="sendbtn" onclick="sendComment()" id="sendCommentBtn">
